  ...
  return (
    <div className='relative sm:w-[130px] sm:h-[150px] w-[110px] h-[110px] mob-s:w-[120px] mob-s:h-[120px] mob-m:w-[130px] mob-m:h-[130px] mob-l:w-[140px] mob-l:h-[140px]'>
      ...
      <div className="absolute sm:top-1 sm:left-1 z-30 -top-1 -left-1">
        <ThemeToggleButton variant="gif" url="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExb2U1aHIzNXRpcWt4dXU3MWFlOXFhYjFnbWZ3cXI0cXNkNXUyZWZvYyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/5KCXDVmBcTL8gpOO5C/giphy.gif"
        />
